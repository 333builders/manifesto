...
const Home: NextPage = () => {
  ...
  const verify = async () => {
    try {
      setSigning(true);
      await signMessageAsync({ message: "gm wagmi frens" });
  ...
  return (
    <div className="py-10 bg-[#f3f5f3]">
      ...
      <nav className="flex max-w-7xl w-full items-center mx-auto space-x-5 font-Inter px-2">
        <div className="grow">
          <Image src="/333B_LogoRosso_Tondo 1.svg" width={112} height={60} priority alt="logo"/>
        </div>
        <div className="font-semibold hover:cursor-pointer">Notion</div>
        <div className="font-semibold hover:cursor-pointer">Discord</div>
        <ConnectButton chainStatus={"none"} showBalance={false}/>
      </nav>
      <main>
        <div className="flex flex-col w-full px-3 pt-10">
          <Image src="/333B_LogoRosso_Tondo 2.svg" width={259} height={138} priority alt="big-logo"/>
          ...
          <div className="font-Inter mx-auto w-full max-w-3xl mt-16 space-y-3 italic relative">
            <div className="hidden xl:block absolute -bottom-[50%] -left-[150%]"><Image src="/Futuristic_city.svg" width={1024} height={1024} priority alt="city1"></Image></div>
            <div className="hidden xl:block absolute -bottom-[50%] -right-[150%]"><Image src="/Futuristic_city2.svg" width={1024} height={1024} priority alt="city2"></Image></div>
            ...
            <p>
              ...
              users&apos; expense, but often against them. Thus, a technology that
              was supposed to set us free, became a mean to exploit us.
            </p>
          ...
          <div className="max-w-xl p-8 rounded-xl font-SpaceGrotesk border-[#B7B7B7] border-2 mx-auto mt-20 w-full flex flex-col space-y-4">
            <div className="flex items-center space-x-3 mb-6">
              <Image src="/signature-hand.svg" width={41} height={40} alt="signature-icon"/>
              <div className="text-xl text-[#BF0424] font-semibold grow">
                Signatoors
              </div>
              <div className="flex flex-col text-center">
                <div className="text-2xl font-bold">{signatures && String(signatures.length).padStart(3, '0')}</div>
                <div className="text-xs font-bold">Signatures</div>
              </div>
            </div>
            {signatures &&
              signatures.map((item: Signature) => (
                <div className="my-4 p-4 bg-[#ECECEC] rounded-xl inline-flex flex-col font-SpaceGrotesk mx-2 space-y-6" key={item.address}>
                  <div className="flex space-x-2">
                    <p className="text-[#BF0424] truncate grow">{item.address}</p>
                    <p className="font-semibold">Today</p>
                  </div>
                  <p className="truncate">{item.signature}</p>
                </div>
              ))}
            <div className="mt-8 mx-auto w-20 border-[#BF0424] border-2 rounded-2xl py-2 px-3 hover:cursor-pointer hover:scale-105">
